...
#### Первое задание:
1. Котельников Даниил Андреевич - index.html, строки 69-99 в main.ts
2. Жмеренчук Александр Анатольевич - строки 1-68 в main.ts
#### Второе задание: 
1. Котельников Даниил Андреевич - строки 1-19 и 41-63 в task2.ts
2. Жмеренчук Александр Анатольевич - task2.html, строки 21-39 и 65-90 в task2.ts
